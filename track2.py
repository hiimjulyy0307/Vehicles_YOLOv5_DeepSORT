        ...
        for i, det in enumerate(pred):  # detections per image
           ...
           # cv2.setMouseCallback('hihi',POINTS)
            ...
            if show_vid:
                ...
                cv2.rectangle(im0, (0,0), (310,145), color_green, -1, cv2.LINE_AA)  # filled
                cv2.putText(im0, 'Pham Hai Duong DKCN17', (10,20), font,0.7, color, 1, cv2.LINE_AA)
                cv2.putText(im0, 'Car: ' + str(len(nb_car)), (10,40), font,0.7, color, 1, cv2.LINE_AA)
                cv2.putText(im0, 'Truck: ' + str(len(nb_truck)), (10,60), font,0.7, color, 1, cv2.LINE_AA)
                cv2.putText(im0, 'Bus: ' + str(len(nb_bus)), (10,80), font,0.7, color, 1, cv2.LINE_AA)
                cv2.putText(im0, 'Motorcycle: ' + str(len(nb_motorcycles)), (10,100), font,0.7, color, 1, cv2.LINE_AA)
                cv2.putText(im0, 'Bicycle: ' + str(len(nb_bicycle)), (10,120), font,0.7, color, 1, cv2.LINE_AA)
                cv2.putText(im0, 'Total: ' + str(total), (10,140), font,0.7, color, 1, cv2.LINE_AA)
                cv2.flip(im0,0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--deep_sort_model', type=str, default='osnet_x0_25') #resnext101_32x8d  #osnet_x0_25
